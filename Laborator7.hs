...
data Tree = Lf Int -- leaf
    | Nod Operation Tree Tree -- branch
    deriving (Eq, Show)
...
evalArb :: Tree -> Int
evalArb (Lf n) = n
evalArb (Nod Add t1 t2) = evalArb t1 + evalArb t2
evalArb (Nod Mult t1 t2) = evalArb t1 * evalArb t2

-- 1.4 functie care transforma o expresie in arbore

expToArb :: Expr -> Tree
expToArb (Const n) = Lf n
expToArb (e1 :+: e2) = Nod Add (expToArb e1) (expToArb e2)
expToArb (e1 :*: e2) = Nod Mult (expToArb e1) (expToArb e2)

arb1 = Nod Add (Nod Mult (Lf 2) (Lf 3)) (Nod Mult (Lf 0)(Lf 5))
arb2 = Nod Mult (Lf 2) (Nod Add (Lf 3)(Lf 4))
arb3 = Nod Add (Lf 4) (Nod Mult (Lf 3)(Lf 3))
arb4 = Nod Mult (Nod Mult (Nod Mult (Lf 1) (Lf 2)) (Nod Add (Lf 3)(Lf 1))) (Lf 2)
